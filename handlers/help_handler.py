...
📊 **年代別機能**
- 「2000年代」「1990年代 統計」→ 年代別統計情報（イベント数・年別分布）
- 「2000年代 一覧」「1990年代 一覧」→ 年代別全イベント一覧
- 「90年代 代表」「2000年代 代表」→ 年代別重要イベント一覧
- 「1990年から1999年 概要」「2010年代 概要」→ 年代別概要説明
- 「2000年代 カテゴリ web+tech」→ 2000年代のweb・techカテゴリ統計情報
- 「2000年代 カテゴリ web+tech 一覧」→ 2000年代のweb・techカテゴリイベント一覧
